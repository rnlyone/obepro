<!DOCTYPE html>
<!--
Template Name: PMBORDA - Vuejs, HTML & Laravel Admin Dashboard Template
Author: PixInvent
...
<!-- Mirrored from pixinvent.com/demo/PMBORDA-html-bootstrap-admin-template/html/ltr/vertical-menu-template/dashboard-analytics.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 12 Aug 2021 13:14:15 GMT -->
...
<head>
    ...
    <meta name="description"
        content="PMBORDA admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords"
        content="admin template, PMBORDA admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>{{$title ?? 'Alternat'}} || Learning Test App</title>
    <link rel="apple-touch-icon" href="/app-assets/images/ico/apple-icon-120.html">
    <link rel="shortcut icon" type="image/x-icon"
        href="https://pixinvent.com/demo/PMBORDA-html-bootstrap-admin-template/app-assets/images/ico/favicon.ico">
            ...
            <div class="navbar-header">
                <ul class="nav navbar-nav flex-row">
                    <li class="nav-item me-auto"><a class="navbar-brand" href="/index-2.html"><span class="brand-logo">
                            ...
                            <h2 class="brand-text">PMBORDA</h2>
                        </a></li>
